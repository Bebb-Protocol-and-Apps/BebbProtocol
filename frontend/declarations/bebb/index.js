...
export const canisterId = process.env.BEBB_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bebb.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bebb canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bebb.did.js")._SERVICE>}
 */
